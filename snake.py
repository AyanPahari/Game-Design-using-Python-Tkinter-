...
class main(Tk):
 ...
 def creating_score_board(self):
  self.scoreboard=Label(self, text="Score : {}".format(self.score))
 ...
 def creating_playground(self):
  self.board=Canvas(self, width=PLAYGROUND_WIDTH, height=PLAYGROUND_HEIGHT, background=PLAYGROUND_COLOR)
